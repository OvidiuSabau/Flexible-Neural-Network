...
def trainModel(run_name, layer_sizes, training_file_path, testing_file_path, initial_learning_rate, learning_rate_decay, num_epochs, batch_size, regularization_parameter, save_model = False):
...
def predictUsingModel(model_path, layer_sizes, input_file_path):
